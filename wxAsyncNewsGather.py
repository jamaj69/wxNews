    ...
    async def serve_api(self):
        ...
        async def get_queues():
            try:
                ...
                # in_stage = all IDs committed to this stage (queue + active workers)
                # active   = workers currently processing (from PipelineStage.stats.in_flight)
